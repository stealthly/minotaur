...
node.default['kafka']['producer']['sleep_time'] = "0ms"
node.default['kafka']['producer']['topic'] = "test-1207"
node.default['kafka']['producer']['num_partitions'] = "6"
node.default['kafka']['producer']['graphite_connect'] = "127.0.0.1:2003"
node.default['kafka']['producer']['flush_interval'] = "10s"
