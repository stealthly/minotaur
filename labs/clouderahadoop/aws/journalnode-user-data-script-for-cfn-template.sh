...
# Find hadoop journal nodes that belong to the same deployment and environment
...
chef-solo -c "$REPO_DIR/$LAB_PATH/chef/solo.rb" -j "$REPO_DIR/$LAB_PATH/chef/solo_journalnode.json"
