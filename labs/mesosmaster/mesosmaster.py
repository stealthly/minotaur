...
parser.add_argument('-a', '--aurora-url', default='', help='The Aurora scheduler URL')

def main():
	args, unknown = parser.parse_known_args()
	lab = MesosMaster(args.environment, args.deployment, args.region, args.availability_zone, 
