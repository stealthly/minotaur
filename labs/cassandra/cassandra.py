...
class Cassandra(Lab):
    def __init__(self, environment, deployment, region, zone, instance_count, instance_type):
        super(Cassandra, self).__init__(environment, deployment, region, zone)
...
parser = ArgumentParser(description='Deploy Cassandra to an AWS CloudFormation environment.')
