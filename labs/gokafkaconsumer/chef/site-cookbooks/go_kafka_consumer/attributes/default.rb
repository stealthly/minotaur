...
default['kafka']['consumer']['consumer_id_pattern'] = "stress-consumer-%d"
default['kafka']['consumer']['group_id'] = "stress-test-group"
default['kafka']['consumer']['num_consumers'] = "3"
default['kafka']['consumer']['topic'] = "test"
default['kafka']['consumer']['zookeeper_connect'] = "#{node['kafka']['zk_servers'].sample}:2181"
default['kafka']['consumer']['zookeeper_timeout'] = "1s"
default['kafka']['consumer']['num_workers'] = "2"
...
default['kafka']['consumer']['num_consumer_fetchers'] = "3"
default['kafka']['consumer']['fetch_batch_size'] = "100"
...
default['kafka']['consumer']['requeue_ask_next_backoff'] = "1"
...
default['kafka']['consumer']['steps_ahead'] = "3"
default['kafka']['consumer']['offsets_storage'] = "zookeeper"
default['kafka']['consumer']['auto_offset_reset'] = "largest"
